package com.example.BDRestAPI.controller;

import com.example.BDRestAPI.model.UserEntity;
import com.example.BDRestAPI.service.UserService;
...
public class UserController {
    ...
    @GetMapping
    public List<UserEntity> obterTodos(){return userService.obterTodos();}
